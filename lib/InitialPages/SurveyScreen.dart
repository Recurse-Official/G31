...
class _SurveyScreenState extends State<SurveyScreen> {
  ...
  //     FirebaseFirestore.instance.collection('surveys').add(surveyData);
  ...
  Future<void> _submitSurvey() async {
    try {
      ...
      // Create a new survey document in the "surveys" collection
      // First, create a new survey document in the 'surveys' collection
      var surveyDocRef =
          await FirebaseFirestore.instance.collection('surveys').add({
        'timestamp': FieldValue.serverTimestamp(),
        // Optional: Track when the survey was created
      });

// Generate a new surveyId for each survey by using the document reference ID
      String surveyId = surveyDocRef.id;

// Now add the survey data as a subcollection called "responses" under the new surveyId
